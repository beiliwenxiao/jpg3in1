...
三个语言（Java / PHP / Go）各自启动一个 JSON-RPC HTTP 服务，并互相调用对方的 `hello.sayHello` 方法。

- Java 使用 JDK 内置 HttpServer
...
| 语言 | 端口 | 框架 | 入口文件 |
|------|------|------|----------|
| Java | 8091 | JDK HttpServer | `java/src/main/java/HelloWorld.java` |
| PHP  | 8092 | Webman + Workerman | `php/hello.php` |
...
// 响应
{"jsonrpc": "2.0", "result": "Hello world, I am Java", "id": 1}
```
