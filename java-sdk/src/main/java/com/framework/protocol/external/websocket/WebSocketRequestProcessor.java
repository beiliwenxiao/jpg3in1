...
public class WebSocketRequestProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(WebSocketRequestProcessor.class);
    
    private final ProtocolAdapter protocolAdapter;
    
    public WebSocketRequestProcessor(ProtocolAdapter protocolAdapter) {
    ...
    public ExternalResponse process(ExternalRequest externalRequest) {
        logger.debug("处理 WebSocket 请求: service={}, method={}", 
    ...
    private InternalResponse executeInternalRequest(InternalRequest request) {
        ...
        response.setPayload("Mock WebSocket response".getBytes());
        return response;
    }
}
